...
int Nmain(int argc, const char** argv)
{
	...
	string filename = "img1.jpg"; // parser.get<string>(0);
	...
	resize(image, image, dsrd_size);
	namedWindow("Original_photo");
	imshow("Original_photo", image);
	waitKey(0);
